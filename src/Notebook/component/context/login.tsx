...
const Login: React.FC<LoginProps> = (props) => {
  ...
  const login = async (user: User) => {
    ...
    if (json.success) {
      ...
      props.showAlert('Email and password are incorrect', 'danger');
      setProgress(100);
    }
  };
              ...
              <div className="card p-4">
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="row">
                      <div className="col-6">
                        <button type="submit" className="btn btn-primary px-4 mx-4">
                          Login
                        </button>
                      </div>
              ...
              <div className="card text-white bg-primary py-5 d-md-down-none">
                <div className="card-body text-center">
                  <div>
                    <h2>Login</h2>
                    <p>
                      If you already registered, you can log in into your iNotebook account. If not please register
                    </p>
                    <button type="button" className="btn btn-primary active mt-3" onClick={() => navigate('/signup')}>
                      Register Now!
                    </button>
                  </div>
                </div>
